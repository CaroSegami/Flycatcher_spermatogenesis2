...
fl.minus0<-readRDS("/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/DS1DS2pureminus0.sct.rds")
fl.combined.markers<-read.csv("/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/pure.markers.csv")
...
cf.minus0.rec<-readRDS("/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/cf.minus0.sct.rds")
cf.markers<-read.csv("/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/cf.markers.csv")
...
pf.minus0.rec<-readRDS("/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/pf.minus0.sct.rds")
pf.markers<-read.csv("/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/pf.markers.csv")
...
#fl.top100<-na.omit(fl.top100)
#cf.top100<-na.omit(cf.top100)
#pf.top100<-na.omit(pf.top100)
...
#cfa<-select(cf.top100, X, avg_log2FC, cluster)
#cfa<-pivot_wider(cfa, names_from ="cluster", values_from ="avg_log2FC")

#pfa<-select(pf.top100, X, avg_log2FC, cluster)
#pfa<-pivot_wider(pfa, names_from ="cluster", values_from ="avg_log2FC")
...
#rownames(cfb)=cfb$X
#rownames(pfb)=pfb$X
#ds1torder=cfb[,level_order_cf]
#ds2torder=pfb[,level_order_pf]

#corDs=cor(ds1torder,ds2torder, method = "pearson")
#corp1<-corrplot(corDs, is.corr = FALSE,method = 'color')
#corp2<-corrplot(corDs, is.corr = FALSE,method = 'number',number.cex = 0.6) #  number


####I think this was my way of doing it.
...
########################################Forget all that was for avg expression
...
#write.csv(top10_markers_roc,file = "/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/Tables/top10markers_roc_pure.csv")
...
#write.csv(All_rocmarkers,file = "/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/Tables/All_rocmarkers_pure.csv")
All_rocmarkers<-read.csv(file="/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/Tables/All_rocmarkers_pure.csv",sep=",")
...
positions<-read.table("/Users/carosegami/Downloads/full.genes.on.fAlb15.chromPos_strict.from_gtf.bed", sep = "\t")
genes <- read.table("/Users/carosegami/Dropbox/RNA seq/filtered_matrixes/filtered_feature_bc_matrix_CF1/features.tsv.gz", stringsAsFactors = FALSE)
...
#write.csv(fl.markers.signif,file = "/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/Tables/fl.markers-pure.signif.csv")
```
...
#write.csv(clusdiffresponse_wilcox_adj,file = "/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/Tables/DEwilcox_cfpf_significant.csv")

clusdiffresponse_wilcox_adj<-read.csv(file = "/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/Tables/DEwilcox_cfpf_significant.csv")

Diff_genes_GO<-distinct(clusdiffresponse_wilcox_adj, V1)
#write.csv(Diff_genes_GO, file="/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/Tables/list_allDEids.csv")

Diff_genes_GO<-read.csv("/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/Tables/list_allDEids.csv")
...
#write.csv(avg.cells.all2,file = "/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/Tables/avg_exppure.csv")
...
#write.csv(avg.cells.all2,file = "/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/Tables/avg_top500pure.csv")

Zavg.top500<- filter(avg.top500, Z=="Z")

avg.top1000<- avg.cells.all2noNA%>%group_by(cluster)%>%top_n(n=1000,wt=all)
#write.csv(avg.cells.all2,file = "/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/Tables/avg_top1000.csv")
...
#write.csv(avg.clus.cells2,file = "/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/Tables/avgexp_all_a.csv")
...
#write.csv(longdfexp_top500,file = "/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/Tables/Top500_expressed.csv")
...
#bootstraping
#write.csv(longdnds_top, file="/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/Tables/top500genespercluster.csv")
...
```{r marker_comparison}
Mouse <- read.table("/Users/carosegami/Dropbox/RNA seq/SCVELO_manuscript1/THE_FINAL_CLUSTERS/Fig_1A_Mouse_unselected_Hermann2018.csv", sep = ",", header = T)
Human <- read.table("/Users/carosegami/Dropbox/RNA seq/SCVELO_manuscript1/THE_FINAL_CLUSTERS/Fig_1B_Human_unselected_Hermann2018.csv", sep = ",", header = T)
