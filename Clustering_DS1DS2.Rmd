...
knitr::opts_knit$set(root.dir = "/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/")
```
...
DS2pure<-readRDS("/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/purespecies2024.rds")
#DS2hybrids<-readRDS("/Users/carosegami/Dropbox/SC_numero2/Analysis/hybrids.rds")
fl.combined<-readRDS("/Users/carosegami/Dropbox/RE-analysisPaperI/RAW_2022/fl.raw.combined_2022.rds")
...
#save seurat obj
saveRDS(pure.combined.sct, file = "/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/pure_clusteredsct.rds")
```
...
#save seurat obj
saveRDS(collareds.combined.sct, file = "/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/collareds.combined.sct.rds")
...
p6
#save seurat obj
saveRDS(pieds.combined.sct, file = "/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/pieds.combined.sct.rds")
...
```{r find}
pure.combined.sct<-readRDS("/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/pure_clusteredsct.rds")
...
#saveRDS
saveRDS(pure.minus0.rec,"/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/DS1DS2pureminus0.sct.rds")

pure.markers <- FindAllMarkers(pure.minus0.rec, only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25)
write.csv(pure.markers, file = "/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/pure.markers.csv")
#pure.markers<-read.csv("/Users/carosegami/Dropbox/SC_numero2/Analysis/pure.markers.csv")
...
```{r find2}
collareds.combined.sct<-readRDS("/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/collareds.combined.sct.rds")
...
#Save reads
saveRDS(cf.minus0.rec,"/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/cf.minus0.sct.rds")


cf.markers <- FindAllMarkers(cf.minus0.rec, only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25)
write.csv(cf.markers, file = "/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/cf.markers.csv")
...
```{r find2}
pieds.combined.sct<-readRDS("/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/pieds.combined.sct.rds")
...
#Save reads
saveRDS(pf.minus0.rec,"/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/pf.minus0.sct.rds")


pf.markers <- FindAllMarkers(pf.minus0.rec, only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25)
write.csv(pf.markers, file = "/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/pf.markers.csv")
...
#save seurat obj
saveRDS(cf.minusSOM.rec, file = "/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/cf.minusSOM.rec.rds")
...
#save seurat obj
saveRDS(pf.minusSOM.rec, file = "/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/pf.minusSOM.rec.rds")
...
#save seurat obj
saveRDS(fl.minusSOM.rec, file = "/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/fl.minusSOM.rec.rds")

minusSOM.markers <- FindAllMarkers(fl.minusSOM.rec, only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25)
write.csv(minusSOM.markers = "/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/minusSOM.markers.csv")
...
#SaveH5Seurat(pf.minus0.rec, filename = #"/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/fl2comb2019.h5Seurat")
#Convert("/Users/carosegami/Dropbox/Re-re-analysisSC1/MBE-Rev/Analysis_combinedDS1DS2/fl2comb2019.h5Seurat", dest = "h5ad")
```